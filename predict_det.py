...
class TextDetector(object):
    ...
    def filter_tag_det_res(self, dt_boxes, image_shape):
        ...
        for box in dt_boxes:
            ...
            # print("rect width is:",rect_width)
            rect_height = int(np.linalg.norm(box[0] - box[3]))
            # print("rect height is:",rect_height)
            if rect_width <= 3 or rect_height <= 3:
                continue
            dt_boxes_new.append(box)
        dt_boxes = np.array(dt_boxes_new)
        # print("dt_boxes looks like:", dt_boxes)
        return dt_boxes
...
if __name__ == "__main__":
    ...
    # print("1.text_detector: ",text_detector)
    ...
    for image_file in image_file_list:
        ...
        print("co-ordinates of the crops looks like:",str(json.dumps([x.tolist() for x in dt_boxes])))
